...
import { getDisputeDetails } from "@/app/actions/utility/dispute-utility";
...
import { Loader2, FileText, ArrowLeft, Calendar, DollarSign, MessageSquare, AlertTriangle, Download, Home, PlusCircle, ListChecks, Gavel } from "lucide-react";
...
export default function PosterDisputeDetail() {
    ...
    async function fetchDisputeData() {
      try {
        ...
        if (result.success && result.data) {
          ...
          // Type assertion to access properties that TypeScript doesn't recognize
          const disputeData = result.data as any;
          const hasResponded = disputeData.hasResponse;
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <div>
                      ...
                      <div className="whitespace-pre-wrap border p-4 rounded-md bg-gray-50 mb-4">
                        {dispute.reason}
                      </div>
                    ...
                    {(dispute.hasResponse as boolean) ? (
                      <div>
                        <h3 className="text-md font-medium mb-2">Your Response</h3>
                        <div className="whitespace-pre-wrap border p-4 rounded-md bg-blue-50 mb-4">
                          {dispute.response}
                        </div>
                        
                        {dispute.responseEvidence && dispute.responseEvidence.length > 0 && (
                          <div className="mt-2">
                            <h4 className="text-sm font-medium mb-2">Your Evidence</h4>
                            <div className="space-y-2">
