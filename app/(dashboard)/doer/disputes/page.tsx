...
import { getUserDisputes } from "@/app/actions/utility/dispute-utility";
...
import { Loader2, FileText, AlertTriangle, Home, Briefcase, Clock, ListChecks, Gavel } from "lucide-react";
...
export default function DoerDisputesPage() {
  const { user } = useUser();
                  ...
                  <Card key={dispute.id} className={dispute.needsResponse ? "border-red-300" : ""}>
                    ...
                    <CardFooter>
                      <Button className="w-full" asChild>
                        <Link href={`/doer/disputes/${dispute.id}`}>
