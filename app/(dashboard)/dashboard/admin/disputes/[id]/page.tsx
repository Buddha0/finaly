...
import { getDisputeDetails, resolveDispute } from "@/app/actions/utility/dispute-utility"
...
import { ArrowLeft, Calendar, DollarSign, Download, FileText, Gavel, Home, ListChecks, Loader2, MessageSquare, ShieldCheck, Users } from "lucide-react"
                ...
                <div>
                  ...
                  <div className="space-y-3 mt-2">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <Avatar className="h-6 w-6">
                          <AvatarImage src={dispute.assignment.poster.image || ""} alt={dispute.assignment.poster.name || "Poster"} />
                          <AvatarFallback>{(dispute.assignment.poster.name || "P").charAt(0)}</AvatarFallback>
                        </Avatar>
                    ...
                    {dispute.assignment.doer && (
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <Avatar className="h-6 w-6">
                            <AvatarImage src={dispute.assignment.doer.image || ""} alt={dispute.assignment.doer.name || "Doer"} />
                            <AvatarFallback>{(dispute.assignment.doer.name || "D").charAt(0)}</AvatarFallback>
                          </Avatar>
