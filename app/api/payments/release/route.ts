...
export async function POST(req: NextRequest) {
  try {
    ...
    // Perform transaction to update both payment and task
    const [updatedPayment, updatedTask] = await prisma.$transaction([
    ...
    console.log(`Payment ${paymentId} released for task ${taskId}. Amount: ${task.payment.amount}`);
